...
### Session空间统计列表接口
> 接口地址:  /plan/planInfo/school/list/session
- 请求方式 GET
- 开发状态: 完成文档, 需要调整
...
### Content空间统计列表接口
> 接口地址:  /plan/planInfo/school/list/content
- 请求方式 GET
- 开发状态: 完成文档, 需要调整
...
### Session批量删除接口
> 接口地址:  /plan/planInfo/school/sessions/delete
- 请求方式 POST
- 开发状态: 完成文档, 需要调整
...
### Content批量删除接口
> 接口地址:  /plan/planInfo/school/contents/delete
- 请求方式 POST
- 开发状态: 完成文档, 需要调整
- 接口说明: 批量删除Content数据
  - 已经发布的课件，必须先下架才能删除
